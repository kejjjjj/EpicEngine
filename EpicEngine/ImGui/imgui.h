...
namespace ImGui
{
    ...
    IMGUI_API void          SameLine(float offset_from_start_x=0.0f, float spacing=-1.0f, bool negative_spacing = false);  // call between widgets or groups to layout them horizontally. X position given in window coordinates.
